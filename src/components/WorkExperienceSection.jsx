...
const experiences = [
  ...
  },
  {
    ...
    description: [
      ...
      "Contributed to microservices architecture by developing service endpoints with Node.js and TypeScript, ensuring seamless inter-service communication via REST APIs.",
      "Gained expertise in microservices architecture, cloud storage solutions, and scalable backend systems through hands-on contributions and collaboration across multiple teams.",
    ],
